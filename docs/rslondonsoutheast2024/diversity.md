...
If you belong to one of these or any other under-represented groups, we’re especially keen to have you at the RSLondonSouthEast 2023 Workshop. We want to help redress the imbalance, make a clear statement about your value to the community and affirm your position as a first-class citizen of it.
...
The RSLondonSouthEast 2024 Workshop will be held in the [Huxley Building](https://www.imperial.ac.uk/engineering/study/current/teaching-spaces/huxley-building---room-308/) at [Imperial College London](https://www.imperial.ac.uk).

The venue has:

- step-free access from the street and car-parks
- step-free access to the rooms where the meeting is being held
- toilets suitable for wheelchair users

[Accessibility guide for the Huxley Building](https://www.accessable.co.uk/imperial-college-london/south-kensington-campus/access-guides/huxley)
...
We understand that the meeting room is not fitted with a hearing loop. Please [get in touch](mailto:rslondonsoutheast2024@rslondon.ac.uk) if this is an area where we can offer accessibility support.
...
This diversity statement is based on the [RSE18 conference diversity statement](https://socrse.github.io/legacy-website/conf2018/diversity-statement/) which is available under a [Creative Commons Attribution 4.0 International License](https://creativecommons.org/licenses/by/4.0/).