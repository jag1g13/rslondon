...
This cookie policy is based on and developed from the [Automattic Cookie Policy](https://github.com/Automattic/legalmattic/blob/master/Cookie-Policy.md) made available under the [Creative Commons Attribution-ShareAlike 4.0 International license](http://creativecommons.org/licenses/by-sa/4.0/). In line with this licence, this Cookie Policy is also made available under the aforementioned licence.

### Change Log

30th August 2018: Cookie Policy customised from the [original version](https://github.com/Automattic/legalmattic/blob/master/Cookie-Policy.md) to suit the Research Software London website.
...
Cookies are placed on the Research Software London website (/). They are stored to your browser when you visit the website.
